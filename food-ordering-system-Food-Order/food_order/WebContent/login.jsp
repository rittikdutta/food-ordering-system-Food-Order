...
<html>
    ...
    <p class="dfHgt">
     ...
     <center><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrF3ieRYER3CDQ2PKaVbngJXsZB0RxoeTbZw&usqp=CAU" class="rounded" style="width:20%" height=70 width=40></center>
